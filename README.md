...
This repository is the draft, Git-native API contract for the username-only `ft_transcendence` Codenames-style game. Open the repository root as a Bruno workspace.
...
1. Start the draft API at `http://localhost:3000`.
